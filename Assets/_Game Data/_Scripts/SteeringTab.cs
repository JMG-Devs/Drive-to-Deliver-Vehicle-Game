...
public class SteeringTab : MonoBehaviour
{
    ...
    IEnumerator Anim()
    {
        ...
        Highlight[PrefsManager.SteeringNumber].SetActive(true);
        for (int i = 0; i < Buttons.Length; i++)
        {
    ...
    public void CheckButtonInteraction()
    {
        ...
        {
            check = PlayerPrefs.GetInt("Steering" + i);
            if (check == 0) continue;
    ...
    public void EnableSelectedIten(int number)
    {
        ...
        PrefsManager.SteeringNumber = number;
