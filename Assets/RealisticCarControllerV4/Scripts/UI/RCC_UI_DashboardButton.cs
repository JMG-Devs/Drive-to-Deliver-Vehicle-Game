...
public class RCC_UI_DashboardButton : RCC_Core, IPointerClickHandler {
    ...
    public Vector3 reversetRotation;
    ...
    public void ChangeGearOnButton()
    {
        ...
        switch (gearDirection)
        {
            ...
            case 0:
                ...
                shiftStick.DOLocalRotate(reversetRotation, 0.15f).SetEase(Ease.Linear);
                break;
            ...
            case -1:
                ...
                shiftStick.DOLocalRotate(new Vector3(0, 0, 0), 0.15f).SetEase(Ease.Linear);
                break;
